...
public class wordextender extends ArrayAdapter<abcd2> {

    private static final String LOG_TAG = wordextender.class.getSimpleName();


    public wordextender(Activity context, ArrayList<abcd2> numbers) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        abcd2 currentAndroidFlavor = getItem(position);
